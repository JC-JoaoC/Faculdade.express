...
const perfilDefault =
  '<img src="images/perfil-default.png" alt="imagem default para perfil">'
...
function adicionarLinha() {
  if (nomes.includes(nomeContato.value) || tel.includes(telContato.value)) {
    alert(
      `O nome ${nomeContato.value} ou telefone ${telContato.value} já forão inseridos na lista`
    )
  } else {
    ...
    corpoTabela.innerHTML += `
            <tr>
                <td>${
                  fotoContato.value
                    ? `<img src=${fotoContato.value} alt="imagem de perfil">`
                    : perfilDefault
                }
                </td>
